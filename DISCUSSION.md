...
### 7. クライアントアプリケーションのアーキテクチャとCORS設定の要否
...
* CORS設定を実装済み（rack-cors gem有効化）
* 環境変数 `ALLOWED_ORIGINS` で許可オリジンを管理
...
| 7  | クライアントアーキテクチャとCORS要否 | 未定   | 未定  | 未着手   |
| 8  | デフォルトソート順              | 未定   | 未定  | 未着手   |
